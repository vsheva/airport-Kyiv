...
const DepartureList = () => {
  ...
  //        item.codeShareData[0].codeShare.toLowerCase().includes(filter.toLowerCase()) || item['airportToID.name_en'].toLowerCase().includes(filter.toLowerCase()) || item.airline.en.name.toLowerCase().includes(filter.toLowerCase())
